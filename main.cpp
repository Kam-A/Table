...
void TestFormulaArithmetic() {
    ...
    ASSERT_EQUAL(evaluate("(12+14) * (14+(13-24/(1+1))*55-46)"), 598);
    ASSERT_EQUAL(evaluate("(12+12) * (14+(13-24/(1+1))*55-46)"), 552);
    ASSERT_EQUAL(evaluate("(12) * (14+(13 + 234 -24/(1+1))*55-46)"), 154716);
}
...
void TestFormulaReferencesMy() {
    ...
    ASSERT_EQUAL(evaluate("A1"), 123);
    sheet->SetCell("A2"_pos, "2423");
    ASSERT_EQUAL(evaluate("A1+A2"), 2546);
}
...
int main() {
    ...
    RUN_TEST(tr, TestFormulaReferencesMy);
    ...
    RUN_TEST(tr, TestPrintMy);
    RUN_TEST(tr, TestPrintError);
